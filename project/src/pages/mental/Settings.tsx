...
import { Moon, Sun, Bell, Lock, User, Brain } from 'lucide-react';

export default function MentalSettings() {
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-400">Customize your Mental Traqr experience</p>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 space-y-8">
        ...
        <div>
          ...
          <div className="space-y-4">
            {Object.entries(emotionPreferences).map(([key, value]) => (
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">Receive weekly emotion insights and tips</p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">Get daily reminders to log your emotions</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  type="checkbox"
